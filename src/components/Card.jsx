...
const Card = ({ data, referenc }) => {
    return (
            ...
            <motion.div drag dragConstraints={referenc} whileDrag={{scale:1.2}} className='flex-shrink-0 relative w-60 h-72 rounded-[20px] bg-zinc-900/90 text-white p-5 overflow-hidden'>
                <FaRegFileAlt />
